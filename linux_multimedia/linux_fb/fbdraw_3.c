...
int main(int argc, char **argv)
{
    ...
    struct fb_var_screeninfo vinfo; //전체 프레임
    ...
    drawline(fbfd, 500, 700, 500, makepixel(255, 0, 0));            /*  Red 선을 출력 */
    drawline(fbfd, 510, 800, 550, makepixel(0, 255, 0));        /*  Green 선을 출력 */
    drawline(fbfd, 520, 900, 600, makepixel(0, 0, 255));        /*  Blue 선을 출력 */
